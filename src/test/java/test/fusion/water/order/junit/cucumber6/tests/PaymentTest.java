...
package test.fusion.water.order.junit.cucumber6.tests;
...
@CucumberOptions(
		...
		features = {"src/test/java/test/fusion/water/order/junit/cucumber6/specs/payment/"},
		glue = {"test.fusion.water.order.junit.cucumber6.steps.payment"}
)
